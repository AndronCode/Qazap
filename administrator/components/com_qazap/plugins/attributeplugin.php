...
abstract class QZAttributePlugin extends QZPlugin
{	
	...
	*/
	...
	public function onDisplayAfterSelection(&$data)
	{
		if($data->plugin != $this->_name)
		{
			return;
		}

		$data->display  = '<span class="attribute-title">' . $data->title . ': </span>';
		$data->display .= '<span class="attribute-value">' . $data->value . '</span>';
