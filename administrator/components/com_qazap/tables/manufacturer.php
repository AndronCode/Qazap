 ...
 */
class QazapTablemanufacturer extends JTable 
{
	...
	*/
	...
	{
		parent::__construct('#__qazap_manufacturers', 'id', $db);
	}
	...
	*/
    public function bind($array, $ignore = '') 
	{
		...
		if ($array['manufacturer_name'] == "")
		{
			$this->setError('Manufacturer Name Cannot be Left Blank');
			return false;	
		}
		
		if ($array['manufacturer_email'] == "")
		{
			$this->setError('Shopper Group Cannot be Left Blank');
			return false;	
		}
