 ...
 */
class QazapTableuserfield extends JTable 
{
	...
	*/
	...
	{
		parent::__construct('#__qazap_userfields', 'id', $db);
	}
	...
	*/
	public function bind($array, $ignore = '') 
	{
		...
		if($array['id'] == 0)
			{
			if(!$this->checkType($array['field_type']))
			{
		...
		if(!JFactory::getUser()->authorise('core.admin', 'com_qazap.userfield.'.$array['id']))
		{
			$actions = JFactory::getACL()->getActions('com_qazap','userfield');
			$default_actions = JFactory::getACL()->getAssetRules('com_qazap.userfield.'.$array['id'])->getData();
			$array_jaccess = array();
