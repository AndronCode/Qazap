...
* View to edit
*/
class QazapViewCurrency extends JViewLegacy
{
	protected $state;
	protected $item;
	protected $form;
	...
	*/
	protected function addToolbar()
	{
		...
		if($isNew)
		{
			JToolBarHelper::title(JText::_('COM_QAZAP') . ': ' . JText::_('COM_QAZAP_CURRENCY_ADD'), ' qzicon-tag8');
		}
		else
		{
			JToolBarHelper::title(JText::_('COM_QAZAP') . ': ' . JText::_('COM_QAZAP_TITLE_CURRENCIES') . '- ' . $this->item->currency, ' qzicon-tag8');	
		}
