...
*/
class QazapViewMembers extends JViewLegacy
{
	protected $items;
	...
	*/
	public function display($tpl = null)
	{
		...
		QazapHelper::addSubmenu('members');
	...
	*/
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_QAZAP') . ': ' .JText::_('COM_QAZAP_TITLE_MEMBERS'), ' qzicon-user7');
		...
		JHtmlSidebar::setAction('index.php?option=com_qazap&view=members');
