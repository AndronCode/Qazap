...
<form action="<?php echo JRoute::_('index.php?option=com_qazap&view=waitinglist'); ?>" method="post" name="adminForm" id="adminForm">
...
<?php endif;?>
		...
		<table class="table table-striped" id="couponList">
			<thead>
				...
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_QAZAP_WISHLIST_NAME', 'b.name', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'JGLOBAL_USERNAME', 'b.username', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_QAZAP_WISHLIST_PRODUCT_NAME', 'pd.product_name', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'JGLOBAL_EMAIL', 'a.user_email', $listDirn, $listOrder); ?>
				</th>
			...
			<?php foreach ($this->items as $i => $item) :
				...
				<td>
				<?php if($item->name):?>
					<?php $returnURL = JRoute::_('index.php?option=com_qazap&view=wishlist');?>
<a href="<?php echo JRoute::_('index.php?option=com_users&task=user.edit&id='.(int) $item->user_id); ?>">
				...
				<td>
					...
					<?php echo ($item->username)? $item->username : 'Guest'	; ?>
				</td>
				<td>
				<?php
