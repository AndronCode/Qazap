 ...
 */
class QazapViewWaitinglist extends JViewLegacy
{
	protected $items;
	...
	*/
	public function display($tpl = null)
	{
		...
		QazapHelper::addSubmenu('waitinglist');
	...
	*/
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_QAZAP') . ': ' .JText::_('COM_QAZAP_TITLE_WAITINGLIST'), '  qzicon-pushpin');

		if($canDo->get('core.delete'))
		{
			JToolBarHelper::deleteList('', 'waitinglist.delete','JTOOLBAR_DELETE');
		}
		...
		JHtmlSidebar::setAction('index.php?option=com_qazap&view=waitinglist');
