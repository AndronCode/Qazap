			...
			<?php foreach ($this->items as $i => $item) :
				...
				<tr class="row<?php echo $i % 2; ?>" sortable-group-id="<?php echo $item->parent_id; ?>" item-id="<?php echo $item->category_id ?>" parents="<?php echo $parentsStr ?>" level="<?php echo $item->level ?>">                    
					...
					<td>
						...
						<?php endif; ?>
						<a href="javascript:void(0)" onclick="if (window.parent) window.parent.<?php echo $this->escape($function);?>('<?php echo $item->category_id; ?>', '<?php echo $this->escape(addslashes(($item->title))); ?>', '', null, null, null, null);">
