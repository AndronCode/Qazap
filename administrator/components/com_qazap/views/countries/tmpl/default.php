...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_qazap&task=countries.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_qazap&view=countries'); ?>" method="post" name="adminForm" id="adminForm">
...
<?php endif;?>
		...
		<table class="table table-striped" id="countryList">
			<thead>
				...
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_QAZAP_COUNTRIES_COUNTRY_NAME', 'a.country_name', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_QAZAP_COUNTRIES_COUNTRY_3_CODE', 'a.country_3_code', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_QAZAP_COUNTRIES_COUNTRY_2_CODE', 'a.country_2_code', $listDirn, $listOrder); ?>
				</th>
			...
			<?php foreach ($this->items as $i => $item) :
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_qazap&task=country.edit&id='.(int) $item->id); ?>">
