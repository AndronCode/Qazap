...
<form action="<?php echo JRoute::_('index.php?option=com_qazap&view=review&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="review-form" class="form-validate">
	<div class="form-inline form-inline-header">
		<div class="control-group">
			<div class="control-label"><?php echo $this->form->getLabel('review_summary'); ?></div>
			<div class="controls"><?php echo $this->form->getInput('review_summary'); ?></div>
		</div>
	</div>
