 ...
 * View to edit
 */
class QazapViewReview extends JViewLegacy
{
	protected $state;
	protected $item;
	protected $form;
	...
	*/
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_QAZAP_TITLE_REVIEW'), 'review.png');
		if($isNew)
		{
			JToolBarHelper::title(JText::_('COM_QAZAP') . ': ' . JText::_('COM_QAZAP_REVIEW_ADD'), ' qzicon-pencil2');
		}
		else
		{
			JToolBarHelper::title(JText::_('COM_QAZAP') . ': ' . JText::_('COM_QAZAP_TITLE_REVIEWS') . ' - ' . JFactory::getUser($this->item->user_id)->name, ' qzicon-pencil2');	
		}
