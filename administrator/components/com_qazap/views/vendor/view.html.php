 ...
 * View to edit
 */
class QazapViewVendor extends JViewLegacy
{
	protected $state;
	protected $item;
	protected $form;
	...
	*/
	protected function addToolbar()
	{
		...
		if($isNew)
		{
			JToolBarHelper::title(JText::_('COM_QAZAP') . ': ' . JText::_('COM_QAZAP_VENDORS_ADD'), ' qzicon-brain');
		}
		else
		{
			JToolBarHelper::title(JText::_('COM_QAZAP') . ': ' . JText::_('COM_QAZAP_TITLE_VENDORS') . ' - ' . $this->item->shop_name, ' qzicon-brain');	
		}
