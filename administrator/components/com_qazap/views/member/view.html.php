...
* View to edit
*/
class QazapViewMember extends JViewLegacy
{
	protected $state;
	protected $item;
	protected $form;
	...
	*/
	public function display($tpl = null)
	{
		...
		$this->membershipHistory = $this->get('MembershipHistory');
	...
	*/
	protected function addToolbar()
	{
		...
		if($isNew)
		{
			JToolBarHelper::title(JText::_('COM_QAZAP') . ': ' . JText::_('COM_QAZAP_MEMBER_ADD'), ' qzicon-user7');
		}
		else
		{
			JToolBarHelper::title(JText::_('COM_QAZAP') . ': ' . JText::_('COM_QAZAP_TITLE_MEMBERS') . ' - ' . JFactory::getUser($this->item->user_id)->name, ' qzicon-user7');	
		}
