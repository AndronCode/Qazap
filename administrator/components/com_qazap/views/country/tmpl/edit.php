...
<form action="<?php echo JRoute::_('index.php?option=com_qazap&view=country&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="country-form" class="form-validate">
