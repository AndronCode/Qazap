...
<script type="text/javascript">
    ...
    {
        if(task == 'cartattributestype.cancel'){
            Joomla.submitform(task, document.getElementById('cartattributestype-form'));
        }
        else{
            
            if (task != 'cartattributestype.cancel' && document.formvalidator.isValid(document.id('cartattributestype-form'))) {
...
<form action="<?php echo JRoute::_('index.php?option=com_qazap&view=cartattributestype&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="cartattributestype-form" class="form-validate">
		...
		<div class="row-fluid">
			...
			<div class="span3">
				<fieldset class="form-vertical side-panel-cont">
					...
					<div class="control-group">
						<div class="control-label"><?php echo $this->form->getLabel('check_stock'); ?></div>
						<div class="controls"><?php echo $this->form->getInput('check_stock'); ?></div>
					</div>
					<div class="control-group">
