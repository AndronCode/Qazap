...
* View to edit
*/
class QazapViewCoupon extends JViewLegacy
{
	protected $state;
	protected $item;
	protected $form;
	...
	*/
	public function display($tpl = null)
	{
		...
		$this->usage	= $this->get('CouponUsage');
	...
	*/
	protected function addToolbar()
	{
		...
		if($isNew)
		{
			JToolBarHelper::title(JText::_('COM_QAZAP') . ': ' . JText::_('COM_QAZAP_COUPON_ADD'), ' qzicon-gift2');
		}
		else
		{
			JToolBarHelper::title(JText::_('COM_QAZAP') . ': ' . JText::_('COM_QAZAP_TITLE_COUPONS') . ' - ' . $this->item->coupon_code, ' qzicon-gift2');	
		}
