...
* View to edit
*/
class QazapViewEmailtemplate extends JViewLegacy
{
	protected $state;
	protected $item;
	protected $form;
	...
	*/
	protected function addToolbar()
	{
		...
		if($isNew)
		{
			JToolBarHelper::title(JText::_('COM_QAZAP') . ': ' . JText::_('COM_QAZAP_EMAIL_ADD'), ' qzicon-tag8');
		}
		else
		{
			JToolBarHelper::title(JText::_('COM_QAZAP') . ': ' . JText::_('COM_QAZAP_TITLE_EMAILS') . ' - ' . $this->item->name, ' qzicon-tag8');	
		}
