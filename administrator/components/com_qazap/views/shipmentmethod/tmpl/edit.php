...
<script type="text/javascript">
    ...
    {
        if(task == 'shipmentmethod.cancel'){
            Joomla.submitform(task, document.getElementById('shipmentmethod-form'));
        }
        else{
            
            if (task != 'shipmentmethod.cancel' && document.formvalidator.isValid(document.id('shipmentmethod-form'))) {
...
<form action="<?php echo JRoute::_('index.php?option=com_qazap&view=shipmentmethod&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="shipmentmethod-form" class="form-validate">
	<div class="form-inline form-inline-header">
		<div class="control-group ">
			<div class="control-label"><?php echo $this->form->getLabel('shipment_name'); ?></div>
			<div class="controls"><?php echo $this->form->getInput('shipment_name'); ?></div>
		</div>
	</div>
	<div class="form-horizontal">
		...
		<div class="row-fluid">
			<div class="span9">
				<fieldset class="form-vertical">
					<div class="control-group">
						<div class="control-label"><?php echo $this->form->getLabel('shipment_description'); ?></div>
						<div class="controls"><?php echo $this->form->getInput('shipment_description'); ?></div>
					</div>
				</fieldset>					
			</div>
			<div class="span3">
				<fieldset class="form-vertical">
					<div class="control-group">
						<div class="control-label"><?php echo $this->form->getLabel('shipment_method'); ?></div>
						<div class="controls"><?php echo $this->form->getInput('shipment_method'); ?></div>
					</div>	
					<div class="control-group">
		...
		<div class="row-fluid">
			<div class="span12">
				<fieldset class="form-horizontal" id="ShipmentParams">
					<?php 
