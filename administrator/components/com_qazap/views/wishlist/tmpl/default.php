...
<form action="<?php echo JRoute::_('index.php?option=com_qazap&view=wishlist'); ?>" method="post" name="adminForm" id="adminForm">
...
<?php endif;?>
		...
		<table class="table table-striped" id="couponList">
			<thead>
				...
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'JGLOBAL_EMAIL', 'b.email', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
