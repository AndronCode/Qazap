...
<script type="text/javascript">
    ...
    Joomla.submitbutton = function(task)
    {
        if(task == 'tax.cancel'){
            ...
            if (task != 'taxe.cancel' && document.formvalidator.isValid(document.id('tax-form'))) {
...
<form action="<?php echo JRoute::_('index.php?option=com_qazap&view=tax&layout=edit&id=' . (int) $this->item->id); ?>" method="post" enctype="multipart/form-data" name="adminForm" id="tax-form" class="form-validate">
    <div class="form-inline form-inline-header">
		<div class="control-group">
			<div class="control-label"><?php echo $this->form->getLabel('calculation_rule_name'); ?></div>
			<div class="controls"><?php echo $this->form->getInput('calculation_rule_name'); ?></div>
		</div>
	</div>   
		...
		<div class="row-fluid">
			<div class="span6">
				<fieldset class="form-horizontal">
					...
					<div class="control-group">
						<div class="control-label"><?php echo $this->form->getLabel('type_of_arithmatic_operation'); ?></div>
						<div class="controls"><?php echo $this->form->getInput('type_of_arithmatic_operation'); ?></div>
					</div>					
										
				</fieldset>
			</div>
			<div class="span6">
				<fieldset class="form-hoszntal">
					<div class="control-group">
					...
					<div class="control-group">
						<div class="control-label"><?php echo $this->form->getLabel('zipcodes'); ?></div>
						<div class="controls"><?php echo $this->form->getInput('zipcodes'); ?></div>
					</div>
				</fieldset>
			</div>			
		</div>
