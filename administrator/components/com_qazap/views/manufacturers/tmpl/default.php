...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_qazap&task=manufacturers.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_qazap&view=manufacturers'); ?>" method="post" name="adminForm" id="adminForm">
...
<?php endif;?>
		...
		<table class="table table-striped" id="manufacturerList">
			...
			<?php foreach ($this->items as $i => $item) :
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_qazap&task=manufacturer.edit&id='.(int) $item->id); ?>">
					<?php echo $this->escape($item->manufacturer_name); ?></a>
				<?php else : ?>
