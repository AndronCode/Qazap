...
class JFormFieldQazapshipments extends JFormField
{
	...
	*/
	protected function getInput()
	{
		...
		$html	= array();
		$link	= 'index.php?option=com_qazap&amp;view=shipmentmethods&amp;layout=modal&amp;tmpl=component';
		...
		if ($allowEdit)
		{
			$html[] = '<a class="btn hasTooltip'.($value ? '' : ' hidden').'" href="index.php?option=com_qazap&view=shipmentmethods&layout=modal&tmpl=component&task=shipmentmethods.modal" target="_blank" title="'.JHtml::tooltipText('COM_CONTENT_EDIT_ARTICLE').'" ><span class="icon-edit"></span> ' . JText::_('JACTION_EDIT') . '</a>';
		}

		// Clear article button
		if ($allowClear)
		{
			$html[] = '<button id="'.$this->id.'_clear" class="btn'.($value ? '' : ' hidden').'" onclick="return jClearShipments(\''.$this->id.'\')"><span class="icon-remove"></span> ' . JText::_('JCLEAR') . '</button>';
		}
