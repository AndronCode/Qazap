...
JLoader::register('QZProducts', JPATH_ADMINISTRATOR . '/components/com_qazap/helpers/products.php');
 ...
 * @since       1.0.0
 */
class JFormFieldQazapProductOrder extends JFormFieldList
{
	/**
	* The form field type.
	*
	...
	* @since  1.0.0
	*/
	protected $type = 'QazapProductOrder';
	...
	*/
	protected function getOptions()
	{
		...
		if($app->isAdmin())
		{
			...
			$doc->addStyleSheet(JURI::base(true) . '/components/com_qazap/assets/css/qazap.css');			
		}
