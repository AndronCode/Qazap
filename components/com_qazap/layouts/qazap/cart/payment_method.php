...
<label for="<?php echo $field_id ?>" id="<?php echo $lbl_id ?>" class="radio">
	...
	<?php if(!empty($method->logo)) : ?>
		<img src="<?php echo JUri::base(true) . '/' . $method->logo ?>" class="payment-method-logo" alt="<?php echo $method->payment_name ?>" />
	<?php endif; ?>
	<?php echo $method->display ?>
	<?php if($method->payment_description) : ?>
	<div id="<?php echo $desc_id ?>" class="qazap_payment_description<?php echo $active_class ?>">
		<?php echo $method->payment_description ?>
	</div>
	<?php endif; ?>
	<?php if($method->additional_html) : ?>
	<div id="<?php echo $addHTML_id ?>" class="qazap_payment_html<?php echo $active_class ?>">
