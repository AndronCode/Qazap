...
if(typeof Qazap === 'undefined') {
	...
	var Qazap = {	
		...
		qtyPriceChecker: function(minQty, maxQty) {
			var productMinQty = jq('#qzform_params_minimum_purchase_quantity').val();
			var productMaxQty = jq('#qzform_params_maximum_purchase_quantity').val();
			if(productMinQty) {
		...
		sidebar: function() {
			jq('#qazap-sidemenu').find('.qzsidemenu-header > a').click(function(){
