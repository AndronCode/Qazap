...
//////////////////////////////////////////////////////////////////////////////////
// Cloud Zoom V1.0.2 is modified for Qazap component
//////////////////////////////////////////////////////////////////////////////////
(function ($) {
    ...
    function CloudZoom(jWin, opts) {
        ...
        this.init = function () {
            ...
            $mouseTrap.bind('click', function(event) {
            	$(this).parents('.qazap-image-wrap').find('.cloud-zoom-fancybox.active').click();
            })
        };
        img1 = new Image();
        $(img1).load(function () {
        ...
        this.each(function () {
            ...
            if ($(this).is('.cloud-zoom')) {
                ...
                if (!$(this).parent().is('.cloud-zoom-wrap')) {
                    $(this).wrap('<div class="cloud-zoom-wrap" style="top:0px;z-index:999;position:relative;"></div>')
                }
                ...
                $(this).bind('click', $(this), function (event) {
                		$(this).parents('.image-thumbnails').find('.cloud-zoom-gallery, .cloud-zoom-fancybox').removeClass('active');
                		$(this).addClass('active');
                		$(this).siblings('.cloud-zoom-fancybox').addClass('active');
                ...
                if($.fn.fancybox() && $(this).siblings('.cloud-zoom-fancybox').length)
                {
									$(this).siblings('.cloud-zoom-fancybox').fancybox({
                    'cyclic': true,
                    'autoScale': true,
                    'autoDimensions': true,
