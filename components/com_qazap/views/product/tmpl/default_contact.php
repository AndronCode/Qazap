	...
	<form name="qazap-notify-form" class="form-vertical" action="<?php echo JRoute::_($this->product_url)?>" method="post">
		<div class="qazap-popup-content">
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" name="qzform[user_name]" id="qzform_user_name1" value="<?php echo $this->user->name?>" placeholder="<?php echo JText::_('COM_QAZAP_CONTACT_NAME') ?>" required="true" />
				</div>
			</div>
			<div class="control-group">
				<label class="control-label" for="qzform_user_email1"><?php echo JText::_('COM_QAZAP_CONTACT_EMAIL') ?></label>
				<div class="controls">
					<input type="email" name="qzform[user_email]" id="qzform_user_email1" value="<?php echo $this->user->email?>" placeholder="<?php echo JText::_('COM_QAZAP_CONTACT_EMAIL') ?>" required="true" />
				</div>
			</div>
			<div class="control-group">
