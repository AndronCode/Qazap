...
?>
<form action="<?php echo JRoute::_('index.php?option=com_qazap&view=users&tmpl=component&groups=' . $input->get('groups', '', 'BASE64') . '&excluded=' . $input->get('excluded', '', 'BASE64'));?>" method="post" name="adminForm" id="adminForm">
